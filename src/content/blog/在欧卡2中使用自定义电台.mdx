...
![](https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AANHaK-2C52QlWE9gJ52T0dW7jWikqgAAtTKMRvCaYFVMr3imwPPM8UBAAMCAAN5AAM2BA.png)

点击播放。

![](https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AANIaK-2Z09aunMTfJCrNN9JF8mEkuMAAtXKMRvCaYFVrviHhAh7s0MBAAMCAAN5AAM2BA.png)

之后按 <Kbd>fn</Kbd> + <Kbd>f12</Kbd> 打开开发者模式（不同的浏览器打开方式可能会不一样）。

选择 `网络` ，再点击 `重新加载页面` 。

![](https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AANLaK-3Bs8CQKv9olEfUR1q6su4-xAAAtfKMRvCaYFVY9R1kucab0UBAAMCAAN3AAM2BA.png)

找到类型是 `media` 的这一项，点击左边的名称。

![](https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AANMaK-3wBEtLsns3mjHA7uKrzlRBiwAAtrKMRvCaYFVR76Qtgj7TG4BAAMCAAN5AAM2BA.png)

复制从 `https` 开始到 `app_id` 这一串。

![](https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AANOaK-4i-grCku8VK8eKhxnlHWA6sgAAt7KMRvCaYFV69KF3WdQeuEBAAMCAAN5AAM2BA.png)
...
![](https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AANPaK-5QnqV6tD4K28BpoG-Bh5718QAAt_KMRvCaYFV4D-Xfd2jqlwBAAMCAAN4AAM2BA.png)

打开 `live_streams.sii` 文件（用记事本打开）。

按照格式填写（直接改原来的电台就行了），蓝色填刚刚复制的 URL ，红色填名字，黄色填标签，绿色填语言，紫色填比特率（填 128 就行了）。

![](https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AANQaK-6piGOHQEpzC6v9gXdF_Fbrt8AAuXKMRvCaYFVdv4jHmHj1W4BAAMCAAN5AAM2BA.png)
