...
![](https://origin.picgo.net/2025/09/13/FM168f1c3ebd312ee43.png)

点击播放。

![](https://origin.picgo.net/2025/09/13/FM2236169133976a18a.png)

之后按 <Kbd>fn</Kbd> + <Kbd>f12</Kbd> 打开开发者模式（不同的浏览器打开方式可能会不一样）。

选择 `网络` ，再点击 `重新加载页面` 。

![](https://origin.picgo.net/2025/09/13/FM3df0f49ae8a646e44.png)

找到类型是 `media` 的这一项，点击左边的名称。

![](https://origin.picgo.net/2025/09/13/FM5049ca70214b6ef98.png)

复制从 `https` 开始到 `app_id` 这一串。

![](https://origin.picgo.net/2025/09/13/FM65bf84bf363a28ebd.png)
...
![](https://origin.picgo.net/2025/09/13/2115ec9912f8fa5f7f.png)

打开 `live_streams.sii` 文件（用记事本打开）。

按照格式填写（直接改原来的电台就行了），蓝色填刚刚复制的 URL ，红色填名字，黄色填标签，绿色填语言，紫色填比特率（填 128 就行了）。

![](https://origin.picgo.net/2025/09/13/229614882c32b51194.png)
