---
title: "在 Astro 博客中集成音乐播放器"
description: "在 Frosti 博客中集成 AudioPlayer 音乐播放器组件"
pubDate: "JUN 26 2026"
categories:
  - Development
tags:
...
<AudioPlayer 
  src="https://link.jiyiho.cn/orfile/view.php/4cd38ddc0719573d04599e609dfbf96a.mp3"
  lrcText="/music/海阔天空-Beyond-歌词.lrc"
  client:load 
/> 

# 前言

我想在我的博客中添加一个音乐播放器，然后我在 [EveSunMaple](https://www.saroprock.com/) 大佬的博客中发现了一个现成的 `AudioPlayer.tsx` 组件，决定将其移植到我的使用 Frosti 主题的博客中（Frosti也是 [EveSunMaple](https://www.saroprock.com/) 大佬搭建的φ(゜▽゜*)♪）。
...
<Collapse title="新建一个 AudioPlayer.tsx ，粘贴以下内容（已折叠）：">
...
[预览](http://fanzhuo.xyz/blog/audioplayer#heading-0)
...
<LinkCard
  title="JiYiHoLink"
  desc="让分享变得更加简单高效。免费提供所有格式转链接服务。"
  url="https://link.jiyiho.cn/"
  img="https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AAPXaj54rxPR9q0qZrltngpSGsYMtw0AAr4Paxs_T_lVWmSTkpC37GYBAAMCAANtAAM8BA.png"
/>
...
<LinkCard
  title="videotourl"
  desc="免费MP3转链接工具，秒级获取音频直链。"
  url="https://www.videotourl.com/zh/tools/mp3-to-url"
  img="https://image.fanzhuo.xyz/file/AgACAgUAAyEGAASKws10AAPYaj55DFo6DH2nvQABzDhLdm-AuRH2AAK_D2sbP0_5VfP3nn0girnNAQADAgADbQADPAQ.png"
/>
